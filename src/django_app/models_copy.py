...
class Contractor(models.Model):
    ...
    inn = models.CharField(max_length=50, db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
    caption = models.CharField(max_length=50, db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
...
class Items(models.Model):
    ...
    quantityexec = models.IntegerField(db_column='quantityExec', blank=True, null=True)  # Field name made lowercase.
...
class Machines(models.Model):
    label = models.CharField(primary_key=True, max_length=50, db_collation='Cyrillic_General_CI_AS')
    type = models.CharField(max_length=50, db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
    port = models.IntegerField(blank=True, null=True)
    current_status = models.CharField(max_length=50, db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
...
class MemecUserprofile(models.Model):
    id = models.BigAutoField(primary_key=True)
    telegramm = models.CharField(max_length=50, db_collation='Cyrillic_General_CI_AS')
...
class Messages(models.Model):
    msg = models.TextField(db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
...
class Orders(models.Model):
    item_id = models.CharField(max_length=50, db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
    label = models.CharField(max_length=50, db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
    quantity = models.IntegerField(blank=True, null=True)
...
class Product(models.Model):
    id = models.IntegerField(primary_key=True)
    code = models.CharField(max_length=50, db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
    caption = models.CharField(max_length=500, db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
    millingtime = models.IntegerField(db_column='millingTime', blank=True, null=True)  # Field name made lowercase.
    lathetime = models.IntegerField(db_column='latheTime', blank=True, null=True)  # Field name made lowercase.
...
class Reports(models.Model):
    ...
    title = models.CharField(max_length=255, db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
    body = models.CharField(max_length=255, db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
    description = models.TextField(db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
    user_name = models.CharField(max_length=50, db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
    html = models.TextField(db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
...
class Request(models.Model):
    id = models.IntegerField(primary_key=True)
    number = models.CharField(max_length=50, db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
    ...
    state = models.CharField(max_length=50, db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
...
class State(models.Model):
    code = models.CharField(primary_key=True, max_length=50, db_collation='Cyrillic_General_CI_AS')
    caption = models.CharField(max_length=50, db_collation='Cyrillic_General_CI_AS', blank=True, null=True)
